...
//editable vars
var beginValue = "0"; //The primary value of the thermometer
...
//Value of the title of the level
var labels = ['', '', '', '', '', '', '', '', '']

//standard resolution images
var glassTopImg = "/static/thermometer/demov1/images/glassTop.png";
var glassBodyImg = "/static/thermometer/demov1/images/glassBody.png";
var redVerticalImg = "/static/thermometer/demov1/images/redVertical.png";
var tooltipFGImg = "/static/thermometer/demov1/images/tickShine.png";
var glassBottomImg = "/static/thermometer/demov1/images/glassBottom.png";
var tootipPointImg = "/static/thermometer/demov1/images/tooltipPoint.png";
var tooltipMiddleImg = "/static/thermometer/demov1/images/tooltipMiddle.png";
var tooltipButtImg = "/static/thermometer/demov1/images/tooltipButt.png";

//high res images
var glassTopImg2x = "/static/thermometer/demov1/images/glassTop2x.png";
var glassBodyImg2x = "/static/thermometer/demov1/images/glassBody2x.png";
var redVerticalImg2x = "/static/thermometer/demov1/images/redVertical2x.png";
var tooltipFGImg2x = "/static/thermometer/demov1/images/tickShine2x.png";
var glassBottomImg2x = "/static/thermometer/demov1/images/glassBottom2x.png";
var tootipPointImg2x = "/static/thermometer/demov1/images/tooltipPoint2x.png";
var tooltipMiddleImg2x = "/static/thermometer/demov1/images/tooltipMiddle2x.png";
var tooltipButtImg2x = "/static/thermometer/demov1/images/tooltipButt2x.png";
...
function createGraphics(){
	...
	$(".goal-thermometer").html(
		...
		"<div class='therm-graphics'>" +
			...
			"<div class='therm-tooltip'>" +
				...
				"<div class='tip-middle'><p>"+beginValue+"</p></div>" + 
	...
	//Change space of label for ascii caracter
	for(label in labels){
        var chaine = labels[label].split(/\s/);
        var newLabel = "";
        for(mot in chaine){
            newLabel += chaine[mot];
            newLabel += "&#32;";
    ...
    //Add the first label for the level 0 who are not display
	...
	for ( var i = 0; i < tickMarkSegementCount; i++ ) {
		...
		$( numbersDiv ).append( "<div title="+labels[tickMarkSegementCount-i]+" class='therm-number pos" + i + "'>" +dollarText+ "</div>" );
